...
-- INSERT INTO Travel_Spot (user_id, spotname, date_shared, city_id, base_price, max_capacity, availability)
INSERT INTO Travel_Spot (user_id, spotname, date_shared, city_id, base_price, max_capacity, availability) VALUES
(2, 'MLDB Cafe', '2024-11-19', 4, 500.00, 30, 'Available'),
(2, 'MaryJay Hidden Garden', '2024-10-15', 3, 800.00, 25, 'Available'),
(3, 'Judy Anns Secret Beach', '2024-09-20', 7, 1200.00, 40, 'Available'),
(3, 'DLSU Heritage Walk', '2024-08-10', 3, 300.00, 50, 'Available'),
(4, 'Hakone Hot Springs', '2024-07-05', 1, 2500.00, 20, 'Available'),
(5, 'Tokyo Night Market', '2024-06-12', 8, 600.00, 100, 'Available'),
(6, 'Sapporo Snow Festival Spot', '2024-05-18', 9, 1500.00, 60, 'Available'),
(7, 'Angeles Hidden Waterfall', '2024-04-22', 5, 700.00, 35, 'Available'),
(8, 'San Fernando Food Street', '2024-03-30', 6, 400.00, 45, 'Available'),
(9, 'Las Pinas Bamboo Organ Church', '2024-02-14', 7, 200.00, 80, 'Available');

-- INSERT INTO TS_Category (location_id, category_id)
INSERT INTO TS_Category (location_id, category_id) VALUES
-- MLDB Cafe (location_id: 1)
(1, 6),  -- Food & Dining
(1, 8),  -- Urban

-- MaryJay Hidden Garden (location_id: 2)
(2, 7),  -- Nature
(2, 4),  -- Cultural

-- Judy Anns Secret Beach (location_id: 3)
(3, 1),  -- Beach
(3, 5),  -- Adventure

-- DLSU Heritage Walk (location_id: 4)
(4, 3),  -- Historical
(4, 4),  -- Cultural

-- Hakone Hot Springs (location_id: 5)
(5, 7),  -- Nature
(5, 4),  -- Cultural

-- Tokyo Night Market (location_id: 6)
(6, 6),  -- Food & Dining
(6, 10), -- Entertainment

-- Sapporo Snow Festival Spot (location_id: 7)
(7, 4),  -- Cultural
(7, 10), -- Entertainment

-- Angeles Hidden Waterfall (location_id: 😎
(8, 7),  -- Nature
(8, 5),  -- Adventure

-- San Fernando Food Street (location_id: 9)
(9, 6),  -- Food & Dining
(9, 8),  -- Urban

-- Las Pinas Bamboo Organ Church (location_id: 10)
(10, 9),  -- Religious
(10, 3); -- Historical
...
SELECT ts.location_id, ts.spotname, c.city_name, r.region_name, co.country_name,
