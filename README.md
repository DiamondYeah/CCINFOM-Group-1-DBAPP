...
I have uploaded both the SQL file and the starting Java Files for the group to work with. Please follow the comments provided in the MainDBController on what to do and how to connect your own MVC implementation.
