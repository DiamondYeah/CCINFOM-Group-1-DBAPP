        ...
        switch(command){
            ...
            case LoginPageViewer.LOGIN_PERFORMED:
                ...
                if(login()){
                    ...
                    feedbackRecord.setCurrentUserID(currentUser.getUserId());
                    feedbackRecord.getModel().updateUserFeedbackOptions();
                    feedbackRecord.getModel().updateUserReactionOptions();
                    feedbackRecord.getModel().updateReactionOptions();
